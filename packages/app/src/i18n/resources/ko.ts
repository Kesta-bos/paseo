...
export const ko: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      placeholder: "명령을 입력하거나 에이전트를 검색하세요...",
      noMatches: "일치 항목 없음",
      actions: "작업",
      agents: "에이전트",
      newAgent: "새 에이전트",
  ...
  workspace: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          viewPrNoGithub: "GitHub가 연결되어 있지 않아 지금은 PR 보기를 사용할 수 없습니다",
          ...
          createPrNoGithub: "GitHub가 연결되어 있지 않아 지금은 PR 생성을 사용할 수 없습니다",
          ...
          mergePrNotReady:
            "GitHub가 풀 리퀘스트를 병합 준비 완료로 보고할 때까지 PR 병합을 사용할 수 없습니다",
        ...
        toasts: {
          ...
          worktreePathUnavailable: "워크트리 경로를 사용할 수 없습니다",
          failedArchive: "워크트리를 보관하지 못했습니다",
        },
        archiveWarning: {
          title: '"{{worktreeName}}"을(를) 보관할까요?',
          confirm: "보관",
          cancel: "취소",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        archiveFailed: "워크트리를 보관하지 못했습니다",
      },
    },
  },
  newWorkspace: {
    ...
    refPicker: {
      ...
      checkoutHint: "PR #{{number}}을(를) 체크아웃할까요?",
      checkoutPr: "PR #{{number}} 체크아웃",
      dismissCheckoutHint: "PR #{{number}} 체크아웃 힌트 닫기",
  ...
  pairing: {
    ...
    device: {
      loadingOffer: "페어링 offer 불러오는 중...",
      failedToLoadOffer: "페어링 offer를 불러오지 못했습니다.",
      relayDisabled:
        "릴레이가 활성화되어 있지 않습니다. 기기를 페어링하려면 릴레이를 활성화하세요.",
      unavailable: "페어링 offer를 사용할 수 없습니다.",
  ...
  settings: {
    ...
    project: {
      noEditableTarget: "연결된 호스트 중 이 프로젝트의 편집 가능한 복사본이 없습니다.",
      backToProjects: "프로젝트로 돌아가기",
      switchHost: "호스트 전환",
      rename: {
        renamedToast: "프로젝트 이름이 변경되었습니다",
        errorFallback: "프로젝트 이름을 변경할 수 없습니다",
        renameLabel: "프로젝트 이름 변경",
        resetLabel: "프로젝트 이름을 기본값으로 재설정",
        projectNameLabel: "프로젝트 이름",
        saveLabel: "프로젝트 이름 저장",
        cancelLabel: "이름 변경 취소",
        reset: "재설정",
      },
      readFailures: {
        ...
        missingWithHosts: "위에서 다른 호스트로 전환하거나 다시 로드하세요.",
      ...
      metadata: {
        ...
        agentTitle: "에이전트 제목",
        agentTitlePlaceholder: "제목을 명령형으로 40자 이내로 유지하세요",
        branchName: "브랜치 이름",
